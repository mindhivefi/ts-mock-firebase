...
export function createSubscribe<T>(executor: Executor<T>, onNoObservers?: Executor<T>): Subscribe<T> {
  const proxy: any = new ObserverProxy<T>(executor, onNoObservers);
...
class ObserverProxy<T> implements Observer<T> {
   ...
   *   call to subscribe().
   */
  public subscribe(nextOrObserver: PartialObserver<T> | Function, error?: ErrorFn, complete?: CompleteFn): Unsubscribe {
